...
import 'package:qqmusic/utils/DelayTween.dart';

enum SpinKitWaveType { start, end, center }

class SpinWave extends StatefulWidget {
...
class _SpinKitWaveState extends State<SpinWave>
  ...
  void initState() {
    super.initState();
    _scaleCtrl = (widget.controller ?? AnimationController(vsync: this, duration: widget.duration))
        ..repeat();
  }

  @override
  void dispose() {
    widget.controller ?? _scaleCtrl.dispose();
    super.dispose();
  }
